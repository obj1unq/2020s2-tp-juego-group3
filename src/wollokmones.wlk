...
const warmander = new Wollokmon(nombre = "warmander", image = "warmander.png", ataque = 10, defensa = 15, especial = 14, movimientos = [ataqueBase, defensa, fuego], ataqueActual = 10, defensaActual = 15, especialActual = 14)
const swirtle = new Wollokmon(nombre = "swirtle", image = "swirtle.png", ataque = 13, defensa = 12, especial = 10, movimientos = [ataqueBase, defensa, agua], ataqueActual = 13, defensaActual = 12, especialActual = 10)
const silvestre = new Wollokmon(nombre = "silvestre", image = "silvestre.png", ataque = 15, defensa = 15, especial = 15, movimientos = [ataqueBase, defensa, rayo, agua, fuego], ataqueActual = 15, defensaActual = 15, especialActual = 15)